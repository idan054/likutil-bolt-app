...
import { Eclipse, MoreHorizontal, PanelBottomClose, X, Check, RefreshCcw, RotateCw, Divide } from 'lucide-react';
...
{(showResults || isLoading) && (
  ...
  <h4 className="text-blue-700 font-medium mb-2 flex items-center gap-2">
    ...
    <span>איך לבחור את האפשרות הטובה ביותר?</span>
  </h4>
            ...
            <>
              <div className="flex justify-between items-center mb-3">
                ...
                <button
                  onClick={handleQuickConnect}
                  disabled={isLoading}
                  className="text-sm px-3 py-1 rounded-lg transition-colors bg-gray-100 hover:bg-gray-200 text-gray-600 hover:text-gray-800 flex items-center gap-1"
                >
